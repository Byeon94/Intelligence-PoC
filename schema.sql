...
-- 여신 메인 화면: 코스피 전 종목 담보대출·우리사주 금융 수요 리드(DART 실데이터, 하루 1회 수집)
...
-- 여신 메인 화면: 상속·증여 관련 뉴스 동향(참고용, AI 관련도 판단, 하루 1회 수집)
...
-- 여신 메인 화면(전체 탭): 담보대출·우리사주 리드 AI 브리핑(하루 1회 생성)
...
-- 여신 메인 화면: 우리사주(유상증자·IPO) 관련 뉴스 동향(참고용, AI 관련도 판단, 하루 1회 수집)
...
-- 여신 > 기업분석 탭: 종목별 '오늘자' 조회 결과 캐시(기초정보·재무정보).
